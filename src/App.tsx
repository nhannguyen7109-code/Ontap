...
const isLessonInSemester = (
  ...
  if (
    lessonName.toLowerCase().includes("ôn tập phần 1") ||
    lessonName.toLowerCase().includes("ôn tập học kì 1")
  )
    return semester === "HK1";
  if (
    lessonName.toLowerCase().includes("ôn tập phần 2") ||
    lessonName.toLowerCase().includes("ôn tập học kì 2")
  )
    return semester === "HK2";
...
const INITIAL_QUESTIONS: Question[] = [
  // Tin học
  {
    ...
    subject: "Tin học",
    grade: "3",
    lesson: "Bài 1 Thông tin và quyết định",
    text: "Chuột máy tính thường có mấy nút cơ bản?",
    options: ["1 nút", "2 nút (Trái, Phải)", "4 nút", "Không có nút nào"],
    correctIndex: 1,
  },
  {
    id: 2,
    subject: "Tin học",
    grade: "3",
    lesson: "Bài 2 Xử lý thông tin",
    text: "Đâu là bộ phận dùng để gõ chữ vào máy tính?",
    options: ["Màn hình", "Chuột", "Bàn phím", "Thùng máy"],
    correctIndex: 2,
  },
  {
    id: 3,
    subject: "Tin học",
    grade: "4",
    text: "Thư mục trên máy tính dùng để làm gì?",
    options: [
      "Để nghe nhạc",
      "Để chứa các tệp tin và thư mục khác",
      "Để chơi game",
      "Để diệt virus",
    ],
    correctIndex: 1,
  },
  {
    ...
    subject: "Tin học",
    grade: "5",
    text: "Phần mềm MS Word dùng để làm gì?",
    options: ["Soạn thảo văn bản", "Vẽ tranh", "Tính toán", "Duyệt web"],
    correctIndex: 0,
  },
  // Công nghệ
  {
    ...
    subject: "Công nghệ",
    grade: "3",
    lesson: "Bài 1 Tự nhiên và công nghệ",
    text: "Vật nào sau đây sử dụng điện để hoạt động?",
    options: ["Cái kéo", "Cái bát", "Bóng đèn", "Quyển vở"],
    correctIndex: 2,
  },
  {
    id: 6,
    subject: "Công nghệ",
    grade: "4",
    text: "Khi sử dụng điện, ta cần chú ý điều gì để đảm bảo an toàn?",
    options: [
      "Cắm điện khi tay ướt",
      "Chơi đùa gần ổ cắm điện",
      "Không chạm tay vào ổ cắm điện",
      "Dùng kéo cắt dây điện",
    ],
    correctIndex: 2,
  },
  {
    ...
    subject: "Công nghệ",
    grade: "5",
    text: "Lắp ráp mô hình cần thực hiện theo bước nào trước tiên?",
    options: [
      "Quan sát hình mẫu",
      "Lắp các bộ phận",
      "Tháo rời",
  ...
  },
  {
    ...
    grade: "3",
    lesson: "Bài 1 Thông tin và quyết định",
    text: "Thiết bị nào dùng để hiển thị hình ảnh từ máy tính?",
    type: "short_answer",
    shortAnswers: ["Màn hình", "man hinh", "màn hình"],
  },
  {
    id: 9,
    subject: "Công nghệ",
    grade: "3",
    lesson: "Bài 2 Sử dụng đèn học",
    text: "Quạt điện dùng năng lượng gì để quay?",
    type: "short_answer",
    shortAnswers: ["Điện", "điện", "dien"],
  },
];
...
export default function App() {
  ...
  const bgmSrc = useMemo(() => {
    ...
    switch (student.grade) {
      case "3":
        return "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-13.mp3";
      case "4":
        return "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-14.mp3";
      case "5":
        return "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-15.mp3";
      default:
        return "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-10.mp3";
    }
  }, [student?.grade]);
  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    if (!classPattern.test(pClass)) {
      setLoginError(
        `Tên lớp chưa hợp lệ! Học sinh Khối ${loginForm.grade} cần nhập lớp bắt đầu bằng số ${loginForm.grade} và kèm theo tên lớp (ví dụ: ${loginForm.grade}A, ${loginForm.grade}B, ${loginForm.grade}A1...) 📝`,
      );
      return;
    }
    ...
    (
      ...
      if (lesson === "HK1" || lesson === "HK2") {
        filtered = filtered.filter(
          (q) =>
            q.lesson && isLessonInSemester(q.lesson, grade, subject, lesson),
        );
      } else if (lesson) {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-indigo-300 via-purple-300 to-pink-300 flex items-center justify-center p-4 font-sans relative overflow-hidden">
        ...
        >
          ...
          <h1 className="text-4xl font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-purple-600 mb-2 drop-shadow-sm">
            Góc Ôn Tập
          </h1>
          <p className="text-gray-500 mb-8 font-medium text-lg">
            Cùng nhau học thật vui nhé!
          </p>
          ...
          {loginMode === "student" ? (
            <form onSubmit={handleLogin} className="space-y-5 text-left">
              <div>
                <label className="block text-sm font-extrabold text-blue-800 mb-2 uppercase tracking-wider">
                  Tên của em:
                </label>
                <input
                  type="text"
              ...
              <div className="flex flex-col sm:flex-row gap-5">
                <div className="flex-1">
                  <label className="block text-sm font-extrabold text-green-800 mb-2 uppercase tracking-wider">
                    Lớp:
                  </label>
                  <input
                    type="text"
                    ...
                    onChange={(e) =>
                      setLoginForm({ ...loginForm, className: e.target.value })
                    }
                ...
                <div className="flex-1">
                  <label className="block text-sm font-extrabold text-purple-800 mb-2 uppercase tracking-wider">
                    Khối:
                  </label>
                  <div className="relative">
                    <select
                      ...
                      onChange={(e) =>
                        setLoginForm({ ...loginForm, grade: e.target.value })
                      }
          ...
          <div className="mt-8 text-center border-t-2 border-gray-100 pt-6">
            ...
            >
              {loginMode === "student"
                ...
                : "Quay lại cổng đăng nhập Học sinh"}
            </button>
          </div>
        </motion.div>
      </div>
    ...
    <div className="min-h-screen bg-[#f0f9ff] flex flex-col md:flex-row font-sans">
      ...
      {isAdmin ? (
        <div className="w-full md:w-80 lg:w-96 md:h-screen sticky top-0 bg-white shadow-xl flex flex-col z-20 border-r border-gray-100 flex-shrink-0">
          ...
          >
            <p className="hidden md:block text-xs font-bold text-gray-400 uppercase tracking-wider mb-2 px-2">
              Bảng Quản Trị
            </p>
            ...
            >
              <PlusCircle
                size={20}
                className={
                  activeTab === "admin" ? "text-purple-600" : "text-gray-400"
                }
              />
          ...
          {activeTab === "admin" && (
            <div className="hidden md:flex flex-col flex-1 overflow-y-auto w-full border-t border-gray-100 p-4">
              ...
              <div className="space-y-4 flex-1">
                {["3", "4", "5"].map((grade) => {
                  const qsForGrade = questions.filter(
                    (q) => String(q.grade) === grade,
                  );

                  return (
                    <details
                      key={grade}
                      className="group border-2 border-indigo-50 rounded-2xl overflow-hidden bg-indigo-50/30"
                      open
                    >
                      ...
                      <div className="p-3 pt-0 space-y-2">
                        {["Tin học", "Công nghệ"].map((subject) => {
                          const qsForSubject = qsForGrade.filter(
                            (q) => q.subject === subject,
                          );
                          ...
                          return (
                            <details
                              key={subject}
                              className="group/sub border border-white rounded-xl overflow-hidden bg-white shadow-sm"
                            >
                              <summary className="cursor-pointer p-2 font-bold text-gray-700 flex items-center justify-between hover:bg-gray-50 transition-colors select-none list-none [&::-webkit-details-marker]:hidden">
                                ...
                                <span className="text-[10px] bg-gray-100 px-2 py-0.5 rounded-md text-gray-500">
                                  {qsForSubject.length}
                                </span>
                              </summary>
                              ...
                              <div className="p-2 border-t border-gray-100 bg-gray-50/50 space-y-2 max-h-[40vh] overflow-y-auto">
                                {qsForSubject.length === 0 ? (
                                  ...
                                  Array.from(
                                    new Set(
                                      qsForSubject.map(
                                        (q) => q.lesson || "Ôn tập chung",
                                      ),
                                    ),
                                  ).map((lesson) => {
                                    const qsForLesson = qsForSubject.filter(
                                      (q) =>
                                        (q.lesson || "Ôn tập chung") === lesson,
                                    );
                                    return (
                                      <details
                                        key={lesson}
                                        className="group/lesson border border-gray-100 rounded-lg overflow-hidden bg-white shadow-sm"
                                      >
                                        <summary className="cursor-pointer p-2 text-xs font-semibold text-gray-600 flex items-center justify-between hover:bg-gray-50 transition-colors select-none list-none [&::-webkit-details-marker]:hidden">
                                          ...
                                          <span className="text-[9px] bg-gray-100 px-1.5 py-0.5 rounded-md text-gray-500 flex-shrink-0">
                                            {qsForLesson.length}
                                          </span>
                                        </summary>
            ...
            <div className="flex items-center gap-3 mb-0 md:mb-2">
              ...
              <div>
                ...
                <p className="text-blue-100 text-xs md:text-sm">
                  Lớp {student?.className} - Khối {student?.grade}
                </p>
              </div>
            </div>
          ...
          <div className="max-w-4xl mx-auto flex flex-col items-center justify-center min-h-[60vh] text-center relative z-10 w-full pt-10">
            ...
            >
              <h1 className="text-4xl md:text-5xl font-black text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-green-500 mb-4 drop-shadow-sm leading-tight">
                Chào {student?.name}! <br className="md:hidden" /> Hôm nay em
                muốn khám phá gì nè?
              </h1>
              <p className="text-xl text-gray-500 font-medium">
                Hãy chọn một hành tinh môn học để bắt đầu nhé! 🚀
              </p>
            </motion.div>
            ...
            <div className="w-full bg-white rounded-3xl shadow-xl overflow-hidden p-6 border-2 border-gray-100">
              ...
              {LESSONS_DATA[student.grade]?.[currentSubject]?.length > 0 ? (
                <div className="space-y-6">
                  {LESSONS_DATA[student.grade][currentSubject].map(
                    (topicGroup, idx) => (
            ...
            <div className="flex flex-col md:flex-row justify-between items-center mb-8 gap-4">
              ...
              <h1 className="text-3xl font-extrabold text-gray-800 flex items-center gap-3">
                {currentSubject === "Tin học" ? (
                  ...
                  <Cpu className="text-green-500" size={36} />
                )}
                ...
                {currentLesson === "HK1"
                  ...
                  : currentLesson === "HK2"
                    ? "Học Kì 2"
                    : ""}
                <span className="bg-yellow-100 text-yellow-800 text-lg px-3 py-1 rounded-full ml-2">
                  Khối {student.grade}
                </span>
              </h1>
            </div>
            ...
            {currentQuestions.length === 0 ? (
              <div className="bg-white p-10 rounded-3xl shadow-sm text-center border-2 border-dashed border-gray-300">
                ...
                <p className="text-gray-500 mt-2">
                  Nhờ thầy cô hoặc bố mẹ thêm câu hỏi cho phần này nhé.
                </p>
              </div>
            ) : isFinished ? (
              ...
              <div className="bg-white p-5 sm:p-8 rounded-3xl shadow-xl relative overflow-hidden border-4 border-white">
                ...
                <div className="w-full bg-gray-100 h-4 rounded-full mb-8 overflow-hidden">
                  <div
                    ...
                    style={{
                      width: `${(currentQIndex / currentQuestions.length) * 100}%`,
                    }}
                  ></div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 relative">
                  ...
                  {currentQuestions[currentQIndex].type === "short_answer" ? (
                    ...
                    (currentQuestions[currentQIndex].optionsObjects || []).map(
                      (opt, idx) => {
                        ...
                        if (answerStatus) {
                          if (idx === answerStatus.index) {
                            ...
                            btnStyle =
                              "bg-green-500 shadow-green-300 animate-pulse";
                          } else {
                            // Các nút còn lại làm mờ đi
                            btnStyle =
                              "bg-gray-300 shadow-gray-200 opacity-50 grayscale";
                          }
                        }
                        ...
                        return (
                          <button
                            ...
                            disabled={!!answerStatus}
                            onMouseEnter={() =>
                              !answerStatus && AudioEngine.playHover()
                            }
            ...
            <div className="bg-white p-8 rounded-3xl shadow-xl border-t-8 border-purple-500">
              ...
              <form onSubmit={handleSaveQuestion} className="space-y-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                  ...
                  <div>
                    ...
                    <select
                      value={newQ.grade}
                      onChange={(e) =>
                        setNewQ({ ...newQ, grade: e.target.value, lesson: "" })
                      }
                      className="w-full p-4 rounded-xl border-2 border-gray-200 bg-gray-50 focus:border-purple-500 focus:ring-4 focus:ring-purple-100 outline-none font-bold text-gray-700"
                    >
                      <option value="3">Khối 3</option>
                  ...
                  <div>
                    ...
                    <select
                      value={newQ.lesson}
                      onChange={(e) =>
                        setNewQ({ ...newQ, lesson: e.target.value })
                      }
                      className="w-full p-4 rounded-xl border-2 border-gray-200 bg-gray-50 focus:border-purple-500 focus:ring-4 focus:ring-purple-100 outline-none font-bold text-gray-700"
                    >
                      <option value="">-- Chọn bài học hoặc để trống --</option>
                      {LESSONS_DATA[newQ.grade]?.[newQ.subject]
                ...
                {newQ.type === "short_answer" ? (
                  ...
                  <div className="space-y-4">
                    <label className="block text-sm font-bold text-gray-700">
                      Các đáp án (Tích chọn vào ô đúng nhất)
                    </label>
                    {[0, 1, 2, 3].map((idx) => (
                      <div
                        key={idx}
                ...
                >
                  <CheckCircle size={24} />{" "}
                  {editingQuestionId ? "Cập Nhật Câu Hỏi" : "Lưu Câu Hỏi Này"}
                </button>
              </form>
            </div>
          </div>
            ...
            {history.filter((h) => h.grade === student?.grade).length === 0 ? (
              <div className="bg-white p-10 rounded-3xl shadow-sm text-center border-2 border-dashed border-gray-300">
                <p className="text-gray-500">
                  Chưa có dữ liệu để xếp hạng cho khối này.
                </p>
              </div>
            ) : (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {["Tin học", "Công nghệ"].map((subject) => {
                  const subjectRecords = history.filter(
                    (h) => h.grade === student?.grade && h.subject === subject,
                  );
                  ...
                  subjectRecords.forEach((record) => {
                    ...
                    if (
                      !bestScores.has(key) ||
                      record.score > bestScores.get(key)!.score
                    ) {
                  ...
                  return (
                    <div
                      key={subject}
                      className="bg-white rounded-3xl shadow-xl overflow-hidden border-t-8 border-yellow-400"
                    >
