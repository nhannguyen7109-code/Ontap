export const LESSONS_DATA: Record<
  string,
  Record<string, { topic?: string; lessons: string[] }[]>
> = {
  "3": {
    "Tin học": [
      {
  ...
  "4": {
    "Tin học": [
      ...
      {
        topic: "CHỦ ĐỀ B. MẠNG MÁY TÍNH VÀ INTERNET",
        lessons: ["Bài 3 Thông tin trên trang web"],
      },
      {
        topic: "CHỦ ĐỀ C. TỔ CHỨC LƯU TRỮ, TÌM KIẾM VÀ TRAO ĐỔI THÔNG TIN",
        lessons: [
      ...
      },
      {
        ...
        lessons: ["Bài 6 Sử dụng phần mềm khi được phép"],
      },
      {
        topic: "CHỦ ĐỀ E. ỨNG DỤNG TIN HỌC",
        lessons: [
          ...
          "Bài 11 Thực hành luyện tập gõ bàn phím",
        ],
      },
      {
        topic: "CHỦ ĐỀ F. GIẢI QUYẾT VẤN ĐỀ VỚI SỰ TRỢ GIÚP CỦA MÁY TÍNH",
  ...
  "5": {
    "Tin học": [
      {
        topic: "CHỦ ĐỀ A: MÁY TÍNH VÀ EM",
        lessons: ["Bài 1: Máy tính có thể giúp em làm những việc gì?"],
      },
      {
        topic: "CHỦ ĐỀ B: MẠNG MÁY TÍNH VÀ INTERNET",
        lessons: ["Bài 2: Tìm thông tin trên website"],
      },
      {
        topic: "CHỦ ĐỀ C: TỔ CHỨC LƯU TRỮ, TÌM HIỂU VÀ TRAO ĐỔI THÔNG TIN",
        lessons: [
      ...
      {
        topic: "CHỦ ĐỀ D: ĐẠO ĐỨC, PHÁP LUẬT VÀ VĂN HÓA TRONG MÔI TRƯỜNG SỐ",
        lessons: ["Bài 5: Bản quyền nội dung thông tin"],
      },
      {
        topic: "CHỦ ĐỀ E: ỨNG DỤNG TIN DỤNG",
        lessons: ["Bài 6: Chỉnh sửa văn bản", "Bài 7: Định dạng kí tự"],
      },
      {
        topic: "CHỦ ĐỀ F: GIẢI QUYẾT VẤN ĐỀ VỚI SỰ TRỢ GIÚP CỦA MÁY TÍNH",
        lessons: [
